// react\src\components\Sidebar\index.tsx
...
import MenuTambahData from './MenuTambahData';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg
                    className="fill-current text-current" // Ensure the icon uses current text color
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {/* <!-- Menu Item Data Arsip Aktif --> */}

              {/* <!-- Menu Item Data Arsip Inaktif --> */}
              <MenuDataArsipInaktif
                sidebarExpanded={sidebarExpanded}
                setSidebarExpanded={setSidebarExpanded}
              />
